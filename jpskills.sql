...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2021. Feb 17. 20:46
...
--
-- A tábla adatainak kiíratása `admin_login`
--

INSERT INTO `admin_login` (`id`, `cardcode`, `password`, `latest_login`, `latest_logout`) VALUES
(1, 126802205, 'adminJelszo', NULL, NULL),
(2, 321456987, 'froccsos', NULL, NULL);
...
--
ALTER TABLE `exams`
  MODIFY `exam_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'az utasítás formalapszáma', AUTO_INCREMENT=26;
...
--
ALTER TABLE `results`
  MODIFY `results_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;

--
-- AUTO_INCREMENT a táblához `skills`
--
ALTER TABLE `skills`
  MODIFY `skills_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
--
ALTER TABLE `admin_login`
  ADD CONSTRAINT `admin_login_ibfk_1` FOREIGN KEY (`cardcode`) REFERENCES `workers` (`worker_cardcode`);
