...
export function AdminVisualizer({ details, successRate, avgPoints, time, isSame, group }) {
    ...
    if(isSame && ['admin', 'Adminisztrátor'].includes(group)){
        return (
            <div className="container shadow rounded text-center bg-light mb-3 py-3">
              ...
              <div className="my-2">
                <h5>
                  Az Ön vizsgáit {details.completion}%-ban teljesítették azok, akik számára
              ...
              <div className="my-2">
                <h5>
                  Globálisan {details.global.completion}%-ban teljesítették a képzettségi mátrix
                  vizsgáit.
                </h5>
        ...
        return(
            <div className="container shadow rounded text-center bg-light mb-3 py-3">
              ...
              <div className="my-2">
                <h5>
                  Ön {details.completion}%-ban teljesítette az Ön számára elérhető vizsgákat.
                </h5>
                {completionPercent(details.completion)}
              </div>
